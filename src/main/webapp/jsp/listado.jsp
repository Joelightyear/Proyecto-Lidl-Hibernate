...
<body>
	<div class="perfil">
		<h5>
			<img alt="" width="30"
				src="http://logos-download.com/wp-content/uploads/2016/03/Lidl_logo.png">Enhorabuena <s:property value="usuario" />
			ha accedido a su cuenta </h5>
	</div>
	<div class="text-center">
		<img alt="" width="700" src="https://onamaconsultora.files.wordpress.com/2014/04/lidl_banner_logo.jpg">
	</div>
	<br>
	<br>
